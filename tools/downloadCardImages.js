...
async function downloadImages(cards) {
    ...
    for (const card of cards) {
        ...
        const filePath = path.join(FRONT_DIR, card.imageFile);
        const backFilePath = path.join(BACK_DIR, card.backImageFile);
        ...
        await downloadFile(
         `https://www.dbsdv.com/images/cardlist/card/${card.imageFile}`,
         filePath
         );

    await downloadFile(
         `https://www.dbsdv.com/images/cardlist/card/${card.backImageFile}`,
          backFilePath
         );
